...
},{"fbjs/lib/invariant":11,"fbjs/lib/warning":10,"./lib/ReactPropTypesSecret":14}],6:[function(require,module,exports) {
...
},{"object-assign":8,"fbjs/lib/invariant":11,"fbjs/lib/emptyObject":12,"fbjs/lib/warning":10,"fbjs/lib/emptyFunction":13,"prop-types/checkPropTypes":9}],4:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":6}],15:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isTextNode":23}],21:[function(require,module,exports) {
'use strict';
...
},{"./camelize":22}],7:[function(require,module,exports) {
/** @license React v16.4.0
...
},{"fbjs/lib/invariant":11,"react":4,"fbjs/lib/warning":10,"fbjs/lib/ExecutionEnvironment":15,"object-assign":8,"fbjs/lib/emptyFunction":13,"prop-types/checkPropTypes":9,"fbjs/lib/getActiveElement":17,"fbjs/lib/shallowEqual":16,"fbjs/lib/containsNode":18,"fbjs/lib/emptyObject":12,"fbjs/lib/hyphenateStyleName":19,"fbjs/lib/camelizeStyleName":20}],5:[function(require,module,exports) {
'use strict';
...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      console.log('mounted');
      _this.getHappinessData();
    }, _this.filter = function (ev) {
      ev.preventDefault();

      var qCountry = document.getElementById('country').val;
      var qScore = document.getElementById('score').val;
      var qRank = document.getElementById('rank').val;

      if (!qCountry && !qScore && !qRank) {
        _this.setState({ happiness: _happiness2.default });
        return;
      }

      var happiness = _happiness2.default.filter(function (happiness) {
        var country = happiness[0];
        var score = happiness[1];
        var rank = happiness[2];

        return countryMatches = !qCountry || country.includes(qCountry);
      });
      _this.setState({ happiness: happiness });
    }, _this.sortByCountry = function () {
      console.log('happiness', _this.state.happiness);
      var ratings = _this.state.happiness.ratings.slice();
      ratings.sort(function (h1, h2) {
      ...
      _this.setState({ happiness: { ratings: ratings } });
      ...
      _this.setState({ happiness: { ratings: ratings } });
    }, _this.getHappinessData = function () {
      _this.setState({ isLoading: true });

      fetch('/ratings?skip=' + _this.state.index).then(function (res) {
        return res.json();
      }).then(function (json) {
      ...
      _this.setState({ index: _this.state.index - 10 }, _this.getHappinessData);
    }, _this.next = function () {
      _this.setState({ index: _this.state.index + 10 }, _this.getHappinessData);
    }, _this.updateUrl = function () {
      var url = "/?index=" + _this.state.index;
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          null,
          'Happiness Ratings Around the World'
        ),
        _react2.default.createElement(
          'p',
          null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { id: 'country', type: 'text', placeholder: 'country name' }),
          _react2.default.createElement('input', { id: 'rank', type: 'number', placeholder: 'happiness rank' }),
          _react2.default.createElement('input', { id: 'score', type: 'number', placeholder: 'happiness score' }),
          _react2.default.createElement(
            'button',
            { type: 'submit' },
            'filter'
        ...
        !this.state.isLoading && this.state.happiness.ratings.map(function (rating, i) {
          return _react2.default.createElement(
            'div',
            { key: rating._id },
            rating.country,
...
},{"react":4,"react-dom":5,"../happiness":3}],25:[function(require,module,exports) {
...
//# sourceMappingURL=/app.03d0b221.map